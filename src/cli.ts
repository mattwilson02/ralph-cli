...
program
  ...
  .option("--max-tool-calls <n>", "effort budget: max agent tool calls per sprint", "400")
  .option("--stall-window <n>", "escalate after this many tool calls with no progress", "40")
  .option("--sprint-timeout <minutes>", "wall-clock backstop for a hung sprint, in minutes", "360")
